...
function countryToLiveIn(language = 'string', isIsland = true, population = 1,  country = 'string'){
...
countryToLiveIn(prompt('language'), prompt('island(true-false)'),prompt('population'),prompt('country'))