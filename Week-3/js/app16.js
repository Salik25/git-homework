...
function password_validation1(password) {
  return password.length > 7 ? "Strong" : "Weak";
}

function advanced_password_validation(password) {
...
console.log(password_validation(prompt('pass')))
console.log(password_validation1(prompt('pass')))
console.log(advanced_password_validation(prompt('pass')))